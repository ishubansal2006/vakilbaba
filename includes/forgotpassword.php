...
$newpassword=($_POST['newpassword']);
  $sql ="SELECT usr_email FROM vk_advocates WHERE usr_email=:email and usr_mobile=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update vk_advocates set usr_pass=:newpassword where usr_email=:email and usr_mobile=:mobile";

...
<section style="margin-top: 70px; background-color:#f2f2f2">
  ...
  <div class="col-md-12" style="text-align: center;">
    ...
    <p style="text-align: justify;">Wants to talk with a <strong>Justics?</strong>.Fill out the form below and mention your query.</p>
  </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="well-box" style="background-color:#ffffff; border:1px solid grey">
            ...
            <h4><u>Talk to Justics</u></h4>
            <p style="font-size: 18px">Book a phone / meeting consultation with a top rated Justics in your city to get detailed opinion on your legal problem starting @ Rs.500 only.</p></center>
            <div class="row">
              <div class="col-md-3" style="margin-left: 120px">
                <center><button type="button" class="btn" style="background-color: #FFBC51; color: #000">Talk to Justics</button></center>
              </div>

        ...
        <div class="profile_wrap">
          ...
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="bankname" required/ autofocus/>
            </div>
            <div class="form-group">
              <label class="control-label" for="accountnumber">Account Number:</label>
              <input class="form-control white_bg" name="accountnumber" required/>
            </div>
            <div class="form-group">
              <label class="control-label" for="ifcs">IFCS Code:</label>
              <input class="form-control white_bg" name="ifcs" required/>
            </div> 

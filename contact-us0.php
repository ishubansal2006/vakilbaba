...
<div class="container" >
        <div class="row mt50" style="margin-top: 10%">
          <div class="col-md-7">
           <div class="map">
        <div id="mask">
    <center>
    <iframe width="500" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="http://maps.google.dk/?ie=UTF8&amp;t=m&amp;ll=55.677875,11.075935&amp;spn=0.048395,0.086002&amp;z=13&amp;output=embed"></iframe>
     ...
     <h1 class="section-header text-center" style="margin-left: 800px; margin-bottom: 50%">Address</h1>
   </div>
  
       <div class="col-md-3">
    <button type="button" class="button button5" data-toggle="modal" data-target="#myModal" style="color: #fff;background: #000; font-weight: bold">Send a message</button>                    

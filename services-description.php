    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-7">
            <div class="panel panel-success">
                <div class="panel-heading" style="text-align: left; background-color: #FFBC51; color: #000"> 
                ...
                <div class="panel-footer">Not Registered?<br><a href="#">
               <i class="fa fa-user"></i> Register here</a>
                </div>
            </div>
        </div>
    </div>
